...
species. It is straightforward for monocrops, but a bit more complicated
...
Here is a depiction of how the model describe the interrow for
intercrops:

\begin{figure}
\centering
\includegraphics{img/Interrow.png}
\caption{\label{fig:interrow}\textbf{Interrow effect on light interception
for intercrops in the STICS model}}
\end{figure}
...
To conclude, we see that the interrow spacing can only impact the light
interception as a density effect (more plants per m2, closer
intra-species canopy), but not as a pure geometrical effect.
